...
<content>
        <div class="content-banner-two bg-four reveal">
          <img class="bg-image" src="<?php echo get_template_directory_uri(); ?>/img/newbg4.jpg"/>
           <div class="home-logo4">
            <img class="bg-logo4" src="<?php echo get_template_directory_uri(); ?>/img/logo_white-p-500.png" />
          </div>
        </div>
